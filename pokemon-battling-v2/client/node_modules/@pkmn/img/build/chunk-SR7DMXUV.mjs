...
var Sprites = class {
  ...
  getPokemon(name, options) {
    ...
    if ((options == null ? void 0 : options.shiny) && gen > 1 && !data.nonshiny) dir += "-shiny";
    ...
    if (graphics in this.ANIMATED) {
      ...
      if (d[facingf] && (options == null ? void 0 : options.gender) === "F") facing = `${facing}f`;
  ...
  getDexPokemon(name, options) {
    ...
    if (graphics in this.ANIMATED) graphics = this.ANIMATED[graphics];
    const data = this.data.getPokemon(name);
  ...
  getSubstitute(options) {
    ...
    if ((options == null ? void 0 : options.side) === "p1") dir += "-back";
...
var Icons = class {
  ...
  getPokemon(name, options) {
    ...
    if (data == null ? void 0 : data.icon) num = data.icon;
    if ((options == null ? void 0 : options.gender) === "F") num = (_b = data == null ? void 0 : data.iconf) != null ? _b : num;
    if ((options == null ? void 0 : options.side) !== "p2") num = (_c = data == null ? void 0 : data.iconl) != null ? _c : num;
...
//# sourceMappingURL=chunk-SR7DMXUV.mjs.map