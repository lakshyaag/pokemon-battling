...
var Data = new class {
  getPokemon(name) {
    var _a, _b, _c, _d;
    let id = toID(name);
    if (id === "toxtricitylowkeygmax") id = "toxtricitygmax";
...
// src/index.ts
var Sprites2 = new (0, _chunkMVXG5PIPjs.Sprites)(Data);
var Icons2 = new (0, _chunkMVXG5PIPjs.Icons)(Data);
