"use strict";Object.defineProperty(exports, "__esModule", {value: true});// src/battle.ts


var _data = require('@pkmn/data');


var _protocol = require('@pkmn/protocol');
...
var Field = class {
  ...
  setTerrain(id, persist) {
    if (id) {
      ...
      this.terrainState = {
        id: _data.toID.call(void 0, this.terrain),
  ...
  setWeather(id, poke, isUpkeep, ability) {
    ...
    if (id) {
      ...
      this.weatherState.id = _data.toID.call(void 0, this.weather);
...
var Handler = class {
  ...
  "|request|"(args) {
    if (!args[1]) return;
    this.battle.request = _protocol.Protocol.parseRequest(args[1]);
  ...
  "|inactive|"(args) {
    ...
    if (args[1].slice(0, 11) === "Time left: ") {
      ...
      if (_data.toID.call(void 0, args[1].slice(0, hasIndex)) === this.player) {
  ...
  "|updatepoke|"(args) {
    ...
    for (let i = 0; i < side.team.length; i++) {
      ...
      if (pokemon.details !== args[2] && pokemon.checkDetails(args[2])) {
        side.addPokemon(_protocol.Protocol.parseDetails(name, pokemonid, args[2]), i);
        break;
      }
    }
  }
  ...
  "|detailschange|"(args) {
    ...
    poke.ability = poke.baseAbility = species.abilities ? _data.toID.call(void 0, species.abilities["0"]) : "";
    poke.details = args[2];
  ...
  "|-activate|"(args, kwArgs) {
    ...
    switch (effect.id) {
      case "poltergeist":
        poke.item = _data.toID.call(void 0, kwArgs.item);
      ...
      case "wanderingspirit": {
        ...
        const pokeability = _data.toID.call(void 0, kwArgs.ability) || poke2.ability;
        const targetability = _data.toID.call(void 0, kwArgs.ability2) || poke.ability;
        if (pokeability) {
...
var Pokemon = class _Pokemon {
  constructor(side, details, set) {
    ...
    this.boosts = {};
    this.volatiles = {};
    this.ability = (set == null ? void 0 : set.ability) ? _data.toID.call(void 0, set.ability) : "";
    this.baseAbility = "";
    this.illusion = void 0;
    this.revealedDetails = void 0;
    this.item = (set == null ? void 0 : set.item) ? _data.toID.call(void 0, set.item) : "";
    this.itemEffect = "";
    this.lastItem = "";
    this.lastItemEffect = "";
  ...
  static parseHealth(hpstring, output = { hp: 0, maxhp: 0, hpcolor: "" }) {
    ...
    void _protocol.Protocol.parseHealth(hpstring, output);
...
var Side = class {
  ...
  setName(name, avatar) {
    ...
    this.id = _data.toID.call(void 0, this.name);
...
var Battle2 = class {
  ...
  add(a, b = {}) {
    const { args, kwArgs } = typeof a === "string" ? _protocol.Protocol.parseBattleLine(a) : { args: a, kwArgs: b };
    const key = _protocol.Protocol.key(args);
    if (!key) return;
  ...
  get(type, s) {
    return !s ? NULL : this.gen[type].get(s) || { name: s, id: _data.toID.call(void 0, s), kind: "Condition" };
  }
  setTurn(turnNum) {
  ...
  getSwitchedPokemon(pokemonid, details) {
    ...
    for (let i = 0; i < side.team.length; i++) {
      ...
      if (!pokemon2.searchid && pokemon2.checkDetails(details)) {
        pokemon2 = side.addPokemon(
          _protocol.Protocol.parseDetails(name, pokemonid, details),
          i
        );
        if (slot >= 0) pokemon2.slot = slot;
        pokemon2.revealedDetails = pokemon2.details;
    ...
    if (this.request && hasIllusion.length && slot >= 0) {
      const detailed = _protocol.Protocol.parseDetails(name, pokemonid, details);
      let pokemon2;
  ...
  rememberTeamPreviewPokemon(sideid, details) {
    ...
    return this.sides[siden].addPokemon(_protocol.Protocol.parseDetails("", "", details));
  }
  getSide(sidename) {
    var _a, _b, _c, _d;
...
exports.Battle = Battle2; exports.Field = Field; exports.NULL = NULL; exports.Pokemon = Pokemon; exports.Side = Side;
