...
class Pokemon {
    ...
    */
    ...
    updateMaxHp() {
        const newBaseMaxHp = Math.floor(Math.floor(2 * this.species.baseStats['hp'] + this.set.ivs['hp'] + Math.floor(this.set.evs['hp'] / 4) + 100) * this.level / 100 + 10);
        ...
        if (this.hp < 0)
            this.hp = this.fainted ? 0 : 1; // latest should never happen
        this.maxhp = newMaxHP;
        if (this.hp)
